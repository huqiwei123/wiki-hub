  ...
  return (
    <Container className="pb-16">
      <section className="w-full py-14 text-center">
        <h1 className="text-4xl font-extrabold tracking-tight text-foreground">About WikiHub</h1>
      ...
      <section className="mx-auto max-w-[900px]">
        <h2 className="text-xl font-extrabold text-foreground">Key Features</h2>
        <div className="mt-5 grid gap-6 md:grid-cols-2">
          {features.map((feature) => (
            <article key={feature.title} className="min-h-[220px] rounded-xl border border-border bg-card p-6 shadow-sm">
              <feature.icon className="size-6" style={{ color: feature.color }} />
              <h3 className="mt-6 font-bold text-foreground">{feature.title}</h3>
      ...
      <section className="mx-auto mt-12 max-w-[900px]">
        <h2 className="text-xl font-extrabold text-foreground">Built With</h2>
      ...
      <section className="mx-auto mt-12 max-w-[900px]">
        <h2 className="text-xl font-extrabold text-foreground">Open Source</h2>
        <div className="mt-4 max-w-md text-sm leading-7 text-muted-foreground">
        ...
        <div className="mt-6 flex gap-3">
          <button className="inline-flex h-11 items-center gap-2 rounded-lg bg-primary px-5 text-sm font-medium text-primary-foreground">
            <span className="text-xs font-bold">GH</span>
            View on GitHub
          </button>
          <button className="inline-flex h-11 items-center gap-2 rounded-lg bg-muted px-5 text-sm font-medium text-muted-foreground">
